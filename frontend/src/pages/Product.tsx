    ...
    try {
      ...
      const mockProducts: Record<string, Product> = {
        ...
        "3": {
          ...
          description: "大号猫抓板，天然材质制作，帮助猫咪磨爪和娱乐，有效保护家具。",
          specs: [
            {
              id: "large",
              name: "大号",
        ...
        "5": {
          ...
          description: "天然植物提取的除臭剂，有效去除异味，持久净味，安全无害。",
          specs: [
            {
              id: "500ml",
              name: "500ml装",
        ...
        "6": {
          ...
          description: "定制宠物相框，精美摆台设计，是纪念爱宠的最佳选择，创意礼品。",
          specs: [
            {
              id: "standard",
              name: "标准版",
      ...
      <div style={{ backgroundColor: "white", padding: "20px" }}>
        ...
        <div style={{ marginTop: "16px" }}>
          ...
          <div style={{
            ...
            <Rate value={product.rating} readOnly allowHalf style={{ fontSize: "12px" }} />
            <span style={{ marginLeft: "8px" }}>
              {product.rating}分 | {product.reviewCount}条评价 | 已售{product.sales}+
            </span>
          </div>
        </div>
      </div>
