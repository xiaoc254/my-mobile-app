...
export default function PetHealthApp() {
  const [currentView, setCurrentView] = useState<
    "main" | "soundCollection" | "soundStopped" | "soundAnalysis"
  >("main");
    ...
    <div style={cardStyle}>
      ...
      <div style={optionsStyle}>
        ...
        <div
          style={{
            ...optionCardStyle,
            background: "linear-gradient(135deg, #b9ab0cff 0%, #d0c11cff 100%)",
          }}
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
        >
  ...
  const renderSoundCollectionView = () => (
    <div style={cardStyle}>
      ...
      <div style={soundContentStyle}>
            ...
            {Array.from({ length: 40 }).map((_, i) => (
              <div
                ...
                style={{
                  ...
                  height: `${
                    10 + Math.sin(i * 0.5) * 20 + Math.random() * 15
                  }%`,
                }}
              ></div>
            ))}
          </div>
          <p style={{ ...collectingTextStyle, color: "#4facfe" }}>
            正在收集...
          </p>
        </div>
        ...
        <p style={{ ...instructionStyle, color: "#666" }}>
          将麦克风对准宠物 收集宠物声音
        </p>
      </div>
      ...
      <div style={analysisContentStyle}>
        ...
        <div style={analysisSummaryStyle}>
          ...
          <p style={{ lineHeight: "1.6", marginBottom: "0", color: "#333" }}>
            ...
            以及可以结合宠物动作进行准确分析。
            <span style={{ ...disclaimerStyle, color: "#666" }}>
              （本次分析由AI生成，注意甄别）
            </span>
          </p>
        </div>
