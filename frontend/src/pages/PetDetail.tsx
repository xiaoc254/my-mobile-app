...
export default function PetDetail() {
  ...
  // 不同宠物的月度计划数据
  const petMonthlyPlans: Record<string, { walk: string; play: string; progress: number }> = {
    buding: {
      walk: '散步60h',
      play: '玩耍80h',
      progress: 45
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ marginBottom: '1px' }}>宠物品种: {currentPet.type}</div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              bottom: '24px',
              width: '2px',
              background: 'linear-gradient(to bottom, #e0e0e0 0%, #e0e0e0 50%, transparent 50%, transparent 100%)',
            ...
            {inProgressTasks.map((task, index) => (
              <div key={task.id} style={{
                ...
                marginBottom: index < inProgressTasks.length - 1 ? '8px' : '0',
                position: 'relative',
                zIndex: 2
              }}>
                {/* 时间点 */}
          ...
          <div style={{
            ...
            <svg width="60" height="60" style={{
              ...
              <circle
                ...
                stroke="#CBA43F"
                strokeWidth="5"
                strokeDasharray={`${2 * Math.PI * 24 * (monthlyPlan.progress / 100)} ${2 * Math.PI * 24}`}
                strokeLinecap="round"
                style={{
