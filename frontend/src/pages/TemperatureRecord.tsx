        ...
        {latestRecord && (
          <div
            style={{
              ...
              border: `2px solid ${
                getConditionInfo(latestRecord.condition).color
              }`,
            }}
          >
            <h3
            ...
            >
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewRecord((prev) => ({
                      ...prev,
                      temperature: parseFloat(e.target.value) || 38.5,
                    }))
                  }
                  style={{
                    width: "100%",
              ...
              {newRecord.temperature > 0 && (
                ...
                >
                  ...
                  <div
                    style={{
                      color: getConditionInfo(
                        getTemperatureCondition(newRecord.temperature)
                      ).color,
                    }}
                  >
                    {
