...
export default function FeedingPlan() {
  ...
  useEffect(() => {
    ...
    const schedules = petFeedingSchedules[currentPetId] || petFeedingSchedules.buding
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ marginBottom: '2px' }}>宠物品种: {currentPet.type}</div>
                ...
                <div key={schedule.id} style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      {schedule.time}喂食{schedule.amount}{schedule.food}
                    </div>
                  </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <svg width="80" height="80" style={{
              ...
              {nutritionData.map((item, index) => {
                const total = nutritionData.reduce((sum, d) => sum + d.value, 0)
                const percentage = item.value / total
                const circumference = 2 * Math.PI * 30
                const strokeDasharray = `${circumference * percentage} ${circumference}`
                const strokeDashoffset = nutritionData.slice(0, index).reduce((sum, d) => sum + (d.value / total) * circumference, 0)
