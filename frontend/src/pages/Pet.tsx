    ...
    switch (taskType) {
      case "exercise":
        ...
        navigate("/exercise-plan", {
          state: { selectedPetId: selectedPetId || "buding" },
        });
        break;
      case "feeding":
        // 跳转到喂食计划页面
                  ...
                  >
                    ...
                    >
                      <img
                        src={
                          pet.avatar ||
                          (pet.type === "cat" ? catImage : dogImage)
                        }
                        alt={pet.nickname}
                        style={{
                          width: "100%",
        ...
        >
          ...
          >
            ...
            >
              <img
                ...
                alt={
                  selectedPetId === "buding"
                    ? "布丁"
                    : selectedPetId === "xueqiu"
                    ? "雪球"
                    : getSelectedPet()?.nickname || "默认头像"
                }
                style={{
                  width: "100%",
                  height: "100%",
          ...
          >
            ...
            >
              ...
              <button
                onClick={() =>
                  taskCompletionStatus.exercise
                    ? handleTaskDelete("exercise")
                    : handleTaskComplete("exercise")
                }
                style={{
                  background: taskCompletionStatus.exercise
                    ? "#dc3545"
                    : "#FFBF6B",
                  border: "none",
                  borderRadius: "12px",
            ...
            >
              ...
              <button
                onClick={() =>
                  taskCompletionStatus.feeding
                    ? handleTaskDelete("feeding")
                    : handleTaskComplete("feeding")
                }
                style={{
                  background: taskCompletionStatus.feeding
                    ? "#dc3545"
                    : "#FFBF6B",
                  border: "none",
                  borderRadius: "12px",
            ...
            >
              ...
              <button
                onClick={() =>
                  taskCompletionStatus.log
                    ? handleTaskDelete("log")
            ...
            >
              ...
              <button
                onClick={() =>
                  taskCompletionStatus.temperature
                    ? handleTaskDelete("temperature")
                    : handleTaskComplete("temperature")
                }
                style={{
                  background: taskCompletionStatus.temperature
                    ? "#dc3545"
                    : "#FFBF6B",
                  border: "none",
                  borderRadius: "12px",
